...
# on a simulated dataset (disease score fluctuation as target)
...
def train_model(filepath,target_column,columns_to_drop,alpha = 0.01,iterations=1000):
    ...
    '''r2 score computed by my GDA implementation for Disease-score_fluct target comes to 0.52,
    r2 score computed using Normal equation 0.63
    r2 score by scikit 0.667'''
