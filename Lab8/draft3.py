...
def logistic_regression_k_folds():
    ...
    for lambda_value in lambda_values:
        ...
        model_lasso = LogisticRegression(penalty='l1', C=1 / lambda_value, solver='liblinear', max_iter=1000)
        ...
        model_ridge = LogisticRegression(penalty='l2', C=1 / lambda_value, max_iter=1000)
